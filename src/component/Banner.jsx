...
const banner = ({handleInputChange},{query}) => {
  return (
    <div className='max-w-screen-2xl container mx auto xl:px-24 px-4 md:py-20 py-14'>
        ...
        <p className='text-lg text-black/70 mb-8 ' >Thousands of jobs in various fields are waiting  </p>
        ...
        <form>
            <div className='flex justify-start md:flex-row flex-col md:gap-0 gap-4'>
                <div className='flex-md:rounded-s-md rounded shadow-sm ring-1 ring-inset ring-gray-300 focus-within:ring-2 focus-within:ring-inset focus-within:ring-indigo-600 md:w-1/2 w-full'>
                    ...
                    placeholder:text-gray-400 focus:right-0 sm:text-sm sm-leeading-6'
                ...
                <div className='flex-md:rounded-s-none rounded shadow-sm ring-1 ring-inset ring-gray-300
                 focus-within:ring-2 focus-within:ring-inset focus-within:ring-indigo-600 md:w-1/3 w-full'>
                    ...
                    placeholder:text-gray-400 focus:right-0 sm:text-sm sm-leeading-6'
                    />
                    {/* <FiMapPin className = 'absolute ml-2 text-gray-400'/> */}
                </div>

                <button type="submit" className='bg-blue py-2 px-8 text-white md:round-s-none rounded '>Search</button>
            </div>
        </form>
    </div>
  )
